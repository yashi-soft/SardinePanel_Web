    ...
    <el-dialog title="修改密码" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="userInfo" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item label="账号" prop="name1">
          <el-input v-model="userInfo.name1" />
        </el-form-item>
        <el-form-item label="原密码" prop="name2">
          <el-input v-model="userInfo.name2" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name1: [{ required: true, message: '原密码不能为空', trigger: 'change' }],
        name2: [{ required: true, message: '新密码不能为空', trigger: 'change' }],
        name3: [{ required: true, message: '确认密码不能为空', trigger: 'change' }]
      }
    }
  },
  computed: {
