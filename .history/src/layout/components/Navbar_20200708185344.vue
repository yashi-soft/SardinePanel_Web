    ...
    <el-dialog title="修改密码" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="原密码" prop="name2">
          <el-input type="password" v-model="userInfo.name2"></el-input>
        </el-form-item>
        <el-form-item label="新密码" prop="name3">
          <el-input type="password" v-model="userInfo.name3"></el-input>
        </el-form-item>
        <el-form-item label="确认密码" prop="name4">
          <el-input type="password" v-model="userInfo.name4"></el-input>
        </el-form-item>
      </el-form>
  ...
  data() {
    let validatePass = (rule, value, callback) => {
      if (value === "") {
        ...
        if (this.userInfo.name4 !== "") {
          this.$refs.ruleForm.validateField("name4");
        }
        callback();
      }
    }
    let validatePass2 = (rule, value, callback) => {
      ...
      } else if (value !== this.userInfo.name3) {
    ...
    return {
      ...
      rules: {
        ...
        name3: [
          { validator: validatePass, message: "新密码不能为空", trigger: 'blur' }
        ],
        name4: [
          { validator: validatePass2, message: "确认密码不能为空", trigger: 'blur' }
        ]
      }
    };
  },
