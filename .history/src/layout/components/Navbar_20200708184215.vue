    ...
    <el-dialog title="修改密码" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label="账号" prop="name1">
          <el-input v-model="name" :readonly="true" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="账号" prop="name2">
          <el-input type="password" v-model="userInfo.name1" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="原密码" prop="name3">
          <el-input type="password" v-model="userInfo.name2" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="原密码" prop="name4">
          <el-input type="password" v-model="userInfo.name2" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
